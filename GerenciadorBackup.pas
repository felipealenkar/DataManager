...
type
  TEnumAcao = (Conectar, Desconectar, Criar, Dropar, Adicionar, Remover, Renomear, Backup, Restaurar, CmdBackup, CmdRestore);
  ...
  TGerenciadorBackup = class (TObject)
    ...
    procedure DefinirParametros(PNomeDoDriverDB, PServer, PPorta, PUsuario, PBiblioteca, PDump, PRestore, PDatabase,
                                POwnerPadrao, PSenha, PExtensao, PTipoQueryDlg: String; PVersaoMinima: Currency);
end;
    ...
    Conectar:
      begin
        try
          ...
          FPgDriver.VendorLib := Biblioteca;
          FConnection.Params.Values['Server'] := Server;
          FConnection.Params.Values['Port'] := Porta;
